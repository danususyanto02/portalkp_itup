...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/up.png">
...
<body class="g-sidenav-show bg-gray-100">
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
          <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="http://portalkp_itup.test/dashboardmhw" target="_blank">
          ...
          <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link  active" href="http://portalkp_itup.test/dashboardmhw">
              ...
              <li class="nav-item">
                <a class="nav-link  " href="http://portalkp_itup.test/jadwalkp">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="d-flex flex-column h-100">
                  ...
                  <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="http://portalkp_itup.test/jadwalkp">
                    Read More
        ...
        <div class="card h-100 p-3">
          <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
            ...
            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
              ...
              <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="http://portalkp_itup.test/jadwalkp">
                Read More
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
              </a>
            </div>
