              ...
              <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                  <div class="form-group">
                    ...
                    <input placeholder="Kegiatan" type="text" name="kegiatan" id="kegiatan" class="form-control" required>
                    <div class="form-group">
                        <label for="tanggal lahir" class="form-control-label">Dari Tanggal</label>
                        <input class="form-control" type="date" name="daritanggal" id="daritanggal"  required>
                      </div>
                      <div class="form-group">
                        <label for="tanggal lahir" class="form-control-label">Sampai Tanggal</label>
                        <input class="form-control" type="date" name="sampaitanggal" id="sampaitanggal"  required>
                      </div>
