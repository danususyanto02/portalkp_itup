          ...
          <div class="col-12">
            <div class="card mb-4">
              <div class="card-header pb-0">
                <a href="{{route('filebriefing.create')}}"> <button type="button" class="btn btn-success " >Upload Video Baru</button></a>
                <h6>Table Video</h6>
              </div>
                  ...
                  <table class="table align-items-center mb-0">
                    ...
                    @foreach ($filebriefing as $key=>$data)
                      <tr>
                        ...
                        <a class="download" href="{{url('storage/file/briefing'.$data->file)}}">DOWNLOAD</a>
                      </tr>
