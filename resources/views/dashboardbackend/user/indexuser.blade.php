        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
             <a href="{{ url('admin/user/create') }}"> <button type="button" class="btn btn-success " >Buat Jadwal Baru</button></a>
              <h6>Jadwal KP</h6>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    @foreach ($user as $jadwal_kps)
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$jadwal_kps->nomor_induk?? ''}}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <h6 class="mb-0 text-sm">{{$jadwal_kps->detail_mahasiswa->alamat ?? ''}}</h6>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <h6 class="mb-0 text-sm">{{$jadwal_kps->role->jenis_role ?? ''}}</h6>
                      </td>
