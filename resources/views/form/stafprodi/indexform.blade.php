        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h4><strong>LIST STAF PROGRAM STUDI</strong></h4>
              <div class="mb-3"></div>
              <div class="col-md-3 ">
                <form action="">
                  <div class="input-group ">
                   <button class="btn btn-outline-primary mb-0" type="submit" >Cari</button>
                    <input type="text" class="form-control text-center " placeholder="Cari Berdasarkan Nama Staf Prodi" name="search" >
                  </div>
                </form>
             </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <form action="{{url('admin/data-staf-prodi/'.$data->id.'/edit')}}" method="GET">
